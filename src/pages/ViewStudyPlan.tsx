...
import { Course, getCourseById, getCoursesFromStudyPlan, getStudyPlan, StudyPlan, validatePrerequisites, ValidRequisitesResponse } from "~/api";
...
function ViewStudyPlan() {
    ...
    const [newValid, setNewValid] = useState<{is_valid: boolean, not_satisfied_prerequisites: {course: Course, prerequisite: Course}[]}>({
                                                is_valid: true,
                                                not_satisfied_prerequisites: []
                                            })
    useEffect(() => {
