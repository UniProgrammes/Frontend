    ...
    return (
        <div style={{ display: "flex", height: "100vh" }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Controls position="top-left"
                                ...
                                <ControlButton onClick={() => setShowFilters(!showFilters)}>
                                    <MixerHorizontalIcon />
                                </ControlButton>
                            </Controls>
                            <Background />
            ...
            <div className="bg-grey-300 h-screen flex flex-col border-l border-gray-300 w-[250px]">
                ...
                <div className={`${showFilters ? "" : "hidden"} fixed top-0 right-0 z-100 bg-white h-screen  flex flex-col gap-3 pt-10 border-l border-gray-300 w-[267px] p-4 box-border`}>
